...
def get_info(DD_token,DD_cookies):
    try:
        info_url = f'https://maicai.api.ddxq.mobi/user/info?api_version=9.1.0&app_client_id=1&station_id={DD_token}&stationId={DD_token}&native_version=&app_version=0&OSVersion=&CityId=1117&latitude=23.018&longitude=113.758948&lat=23.018&lng=113.758948&device_token='
        info_headers = {
...
def tasklist_info(name,uid,DD_token,DD_cookies):
    try:
        ...
        tasklist_url = f'https://farm.api.ddxq.mobi/api/v2/task/list?api_version=9.1.0&app_client_id=1&station_id={DD_token}&stationId={DD_token}&native_version=&app_version=9.53.1&OSVersion=15&CityId=1117&latitude=23.017158&longitude=113.811603&lat=23.017158&lng=113.811603&device_token=BlmHXhUz+ovWxuxqQ5Kr+wUJZZlLKM+JtfEW+FDNv1tfVyDBOJWHOVKT6aIj8EY8ulRObWqbCzxzuX946Ec2Wdw==&gameId=1&cityCode=1117'
        view_headers = {
            "user-agent": f"Mozilla/5.0 (iPhone; CPU iPhone OS 14_7_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 xzone/9.35.1 station_id/{DD_token}",
            "Accept-Encoding": "gzip, deflate, br",
            "Connection": "keep-alive",
...
def lucky_draw_reward(name,uid,taskid,DD_token,DD_cookies):
    try:
        # url = f'https://farm.api.ddxq.mobi/api/v2/task/reward?api_version=9.7.3&app_client_id=4&station_id={DD_token}&native_version=&app_version=9.35.1&uid={uid}&latitude=23.017158&longitude=113.811603&gameId=1&userTaskLogId={taskid}'
        url = f'https://farm.api.ddxq.mobi/api/v2/task/reward?api_version=9.1.0&app_client_id=1&station_id={DD_token}&stationId={DD_token}&native_version=&app_version=9.53.1&OSVersion=15&CityId=1117&latitude=23.017158&longitude=113.811603&lat=23.017158&lng=113.811603&device_token=BlmHXhUz+ovWxuxqQ5Kr+wUJZZlLKM+JtfEW+FDNv1tfVyDBOJWHOVKT6aIj8EY8ulRObWqbCzxzuX946Ec2Wdw==&gameId=1&userTaskLogId={taskid}'
        reward_headers = {
            "user-agent": f"Mozilla/5.0 (iPhone; CPU iPhone OS 14_7_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 xzone/9.35.1 station_id/{DD_token}",
            "Accept-Encoding": "gzip, deflate, br",
            "Connection": "keep-alive",
        ...
        response = requests.get (url=url, headers=reward_headers, verify=False)
        list = response.json ()
        print(list)
